...
class UpdateSocialMediaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'platform' => 'required|string|unique:social_media,platform,' . $this->input('id'),
            'location' => 'required',
    ...
    public function messages() {
        return [
            ...
            'platform.unique' => 'Social media name already taken.',
            'platform.string' => 'Social media name must be a string.',
            ...
            'forms.*.name.max' => 'Post name must not exceed 255 characters.',
